...
class Iframe1 extends Component {
  constructor(props) {
    super(props);
    this.state = {
      bannerSpeed: '2000',
  ...
  <a href=${this.state.url} target="_blank" class="liveframe bannerContainer" style="width: ${this.state.width}; height: ${
    ...
    }; background: ${this.state.colorButtonBackground}; line-height: ${this.state.buttonLineHeight}; font-family: ${
      this.state.font
    };"  id="bg-exit2">${this.state.buttonText}</a>
      <div class="banner-messages" style="background-color: ${this.state.colorMessage};">
      <div class="banner-message banner-message-1" style="display: block; opacity: 1;  color: ${this.state.color1}; font-size: ${this.state.fontSize1} !important; font-family: ${this.state.font}; ${uppercase1} line-height: ${this.state.lineHeight1}px; ${pos1}">${this.state.message1}</div>
...
export default connect(mapStateToProps)(Iframe1);
